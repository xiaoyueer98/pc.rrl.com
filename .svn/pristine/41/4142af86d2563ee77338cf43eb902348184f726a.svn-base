...
function del_resume(d,jid,c){
	...
	$.ajax({
		...
		url:"resume_save.php?action=del&jid="+jid+"&id="+d,
...
function up_resume(id,j_id,idname){

	$.ajax({

		url : "resume_save.php?a=edit&j_id="+j_id+"&id="+id,
...
function up_work(id,j_id,idname){

	$.ajax({

		url : "resume_save.php?a=yinc&j_id="+j_id+"&id="+id,
...
function del_work(d,jid,c){
	...
	$.ajax({
		...
		url:"resume_save.php?action=w_del&jid="+jid+"&id="+d,
...
function zs_update(id,j_id,idname){

	$.ajax({

		url : "resume_save.php?a=kongb&j_id="+j_id+"&id="+id,
...
function zs_del(d,jid,c){
	...
	$.ajax({
		...
		url:"resume_save.php?action=ca_del&jid="+jid+"&id="+d,
...
function del_res(d,jid,c){
	...
	$.ajax({
		...
		url:"resume_save.php?action=del_resume&jid="+jid+"&id="+d,
