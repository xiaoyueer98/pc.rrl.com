		...
		<ul class="pd">
			...
			<li class="pd_list">
				...
				<ul style="display:block">
					...
					<li><a href="<?php echo U('Login/MyMessage1');?>"><em class="hre">我的消息</em></a></li>
...
//-->
		...
		<div class="PersData">
			<div class="myNews">
				<h3>我的消息</h3>
				<div class="NewsFrame">
					<span><img src="/Public/img/qiyeicon.png" alt=""></span>
					<div>
						<i><img src="/Public/img/asa.png" alt=""></i>
						<p>为北京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1京热贝惠卖公司成功推荐PHP工程师1名...</p>
						<ul>
							<li>2015-12-12</li>
							<li><a href="">系统消息</a></li>
							<li class="dle"><img src="/Public/img/dle.png" alt=""></li>
						</ul>
					</div>
				</div>
