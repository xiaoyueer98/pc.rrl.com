...
$(document).ready(function(e) {
    ...
    $catList.mouseenter(function() {
        ...
        if ($(this).bottom > $(this).height()) {
            $catCont.css("bottom", $(this).bottom);
        }
        if (catBottomGap >= catContHeight) {
            $catCont.css("top", catPositionTop);
        }
        if (catBottomGap < catContHeight && viewHeight >= catContHeight) {
            $catCont.css("top", catPositionTop - (catContHeight - catBottomGap));
        }
        if (catBottomGap < catContHeight && viewHeight < catContHeight) {
            $catCont.css("top", catPositionTop);
        }
        if (catBottomGap <= 66) {
            $catCont.css("top", catPositionTop - catContHeight + 66);
        }

    });
    $catList.mouseleave(function(event) {
