...
$(function() {
    ...
    $("#change_telehone_code_step1").click(function() {
        ...
        var hash = $("#hash").val();
        $.post("/Home/Company/changeTelephoneStep1.html", {hash:hash}, function(data) {
            if (data.code != "500") {
    ...
    $("#change_telehone_code_step2").click(function() {
        ...
        */
       var hash = $("#hash").val();
        $.post("/Home/Company/changeTelephoneStep2.html", {'telephone': telephone,'hash':hash}, function(data) {
            if (data.code != "500") {
...
//判断公司基本信息是否填写完整
$(function(){
    $("#sendJobDiv").click(function(){
        $.post("/Home/Company/getuserinfos.html", {}, function(data) {
                if (data.code != "500") {
                    location.href="/Home/Company/SendJob.html";
                } else {
                    sys_window(data.msg,"/Home/Company/EnterpriseInformation.html");
                }
            }, "json")
    });
})