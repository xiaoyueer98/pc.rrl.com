...
define('UC_DBTABLEPRE', 'bbs.stj_ucenter_');			// UCenter 数据库表前缀

//通信相关
define('UC_KEY', '123456789');				// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://localhost:8081/uc_server');	// UCenter 的 URL 地址, 在调用头像时依赖此常量
...
define('UC_DBTABLEPRE', '`bbs`.stj_ucenter_');
define('UC_DBCONNECT', '0');
define('UC_KEY', '123456789');
define('UC_API', 'http://localhost:8114/uc_server');
...
$tablepre = 'stj_ucenter_';   		// 表名前缀, 同一数据库安装多个论坛请修改此处
