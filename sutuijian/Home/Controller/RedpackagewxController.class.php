...
class RedpackagewxController extends Controller {

        protected $values = array();
        protected $wxappid = ""; //微信公众号appid
        protected $mch_id = "";  //微信支付商户id
        protected $redirect_uri = "http://www.renrenlie.com/Home/Redpackagewx/get_openid";  //回调地址
        ...
        public function get_code() {
                ...
                if (C('WX_REDPACKAGE_OPEN') && date("Y-m-d H:i:s") > $actArr['starttime'] && date("Y-m-d H:i:s") < $actArr['endtime'] && C('WX_REDPACKAGE_COUNT') > $countMoney) {
                        ...
                        header("location:/Home/Webchatactive/wxredpackage");
                        die;
                }
                /*************************************判断活动是否开启中*******************************************/
        ...
        public function get_openid() {
                ...
                $this->assign("sharecode", strtoupper($sharecode));
        ...
        public function sendtest() {
                ...
                $wxappid = $this->wxappid;   //微信公众号appid
                $mch_id = $this->mch_id;     //微信支付商户号
                $mch_billno = "1111111111111111111111111111"; //订单号
                $nonce_str = $this->getNonceStr();
