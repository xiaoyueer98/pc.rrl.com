...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .srdz-head{
                height: 25px;
                border-bottom:2px #2281b9 solid;
                line-height: 25px;
                text-align: center;
                font-size: 14px;
                color: #979797
            ...
            .srdz-alt .clos{
                ...
                width: 15px;
                height: 15px;
                background: url(/Public/images/webchatnew/cold.png);
            ...
            .com-list .list.m{
                background: url(/Public/images/webchatnew/icon-r.png) no-repeat right;
            ...
            .com-list .list em.m{
                background: url(/Public/images/webchatnew/icon3.png) no-repeat left center;
            ...
            .com-list .list span.wh{
                width: 62%;
            }
            .com-list .list label#m-tre{
                width: 12px;
                height: 12px;
            ...
            .com-list .list label#m-tre.m{
                background: #206daf
            }
            .com-list .list label.lb-input{
            ...
            .com-list .list label.lb-input input{
                height: 20px;
                margin:0;
                width: 114px;
                text-align: right;
            }
            .com-list .list label.lb-input i{
                display: block;
                height: 20px;
                line-height: 20px;
                float: left;
    ...
    <body>
        ...
        <div class="wrap">
            ...
            <section class="content m-content1" style="padding-bottom:20px;display:block;margin-top:1px;">
                <div class="srdz-banner"><a href="http://m.renrenlie.com"><img src="/Public/images/webchatnew/srdz-banner.png" alt=""></a></div>
                <div class="srdz-text">
                ...
                <div class="clearfix wxts" style="margin-top:15px;">
                    <span>温馨提示：</span>
                    <i></i>
                ...
                <div style="background:#dff1ff;padding:10px 0">
                    ...
                    <div class="com-list">
                        <div class="bd3">
                            <div class="list clearfix"><em class="m">姓&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp名：</em><input type="text" id="name" placeholder="输入真实姓名"></div>
                        </div>
                        <div class="bd3">
                            <div class="list clearfix" id="com-size"><em class="m" style="width:60px;">手&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp机：</em><input  style="width:70px!important"  type="text" id="mobile" placeholder="请输入手机号码"><span class="hqyzm hqyzm2" id="getcode" style="border-left: 1px #c9c9c9  solid;">免费获取验证码</span></div>
                        </div>
                        <div class="bd3">
                            <div class="list clearfix"><em class="m">验&nbsp&nbsp证&nbsp&nbsp码：</em><input type="text" id="verify"></div>
                        </div>
                        <div class="bd3">
                            <div class="list clearfix"><em class="m wh100">方便联系的时间：</em><input class="wh-55" type="text" id="able_time" placeholder="如：随时、周六日等"></div>
                        </div>
                        <div class="bd3">
                            <div class="list clearfix"><em class="m">求职意愿：</em><input type="text" id="want" placeholder="输入职位名称" ></div>
                        </div>
                    </div>
                </div>
                <div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#getcode').click(function () {
                    ...
                    $.post("/Home/Webchatcustomized/send_msg", {
                        mobile: mobile,
                        hash:hash
                    }, function (data) {
                        if (data.code != "200") {
                ...
                $('#btn').click(function () {
                    ...
                    $.post("/Home/Webchatcustomized/info_save", {
                        name: name,
                        mobile: mobile,
                        verify: verify,
                        able_time: able_time,
            ...
            var linkurl = "<?php echo $domain.$share['wxurl']?>";
            var linkimg = "<?php echo $share['img']?>";
