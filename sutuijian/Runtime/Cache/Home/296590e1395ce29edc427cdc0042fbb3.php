...
<html lang="en">
    <head>
        ...
        <style>.mg-candidate .mytable{border: none!important;}
    ...
    <body>
        ...
        <div class="hxrmssj undis">
            <div class="date"><label>候选人面试时间</label><input type="text" id="audstarttime"></div>
            <p>（例如：3月5日全天或3月6日下午，3月5日-7日下午5点以后)</p>
            <p class="p2">重要提示：<br>
                向企业推荐候选人之前，必须同候选人进行沟通。一旦发现“盲目提交”（未经候选人同意即提交职位候选人）遭到客户投诉，人人猎有权终止您的猎头注册用户资格。</p>
            <div class="botm">
                <button class="bt1 querentuijian cur_point">确认推荐</button><button class="bt2 zaigoutongyixia cur_point">再沟通一下</button>
            </div>
        </div>
    ...
    $(document).ready(function(e){
        ...
        $(".m2-l .odiv2").on("mouseleave",function(){
            ...
            <div class="m2-r fl-rig">
                <ul class="nav nav2">
                    <li class="first dis-block dis-inlin fl-lef <?php if($act == ''):?>m<?php endif;?>"><a href="javascript:;"<?php if($act == ''):?>class="m"<?php endif;?>>候选人列表</a></li>
                    <li class="dis-block dis-inlin fl-lef addResumeAct <?php if($act != ''):?>m<?php endif;?>"><a href='javascript:;' <?php if($act != ''):?>class="m"<?php endif;?>>添加候选人简历</a></li>
                </ul>
                <div class="mg-candidate <?php if($act != ''):?>undis<?php endif;?>">
                    <h3>
                        <span class="dis-block dis-inlin fl-lef">候选人</span>
                        <input type="text" placeholder="候选人姓名" id="resume_name" value="<?php echo $resumeName;?>"><button id="serarch-resume-btn">搜索</button>
                        <em class="dis-block dis-inlin fl-rig">
                            <a class="cur_point addResumeAct" href="javascript:;">
                                <img class="dis-inlin dis-block fl-lef" src="/Public/img/rcmd-img/icon4.png"/>
                                <i class="dis-inlin dis-block fl-lef" title="上传优质简历，坐等分钱。">上传候选人简历</i></a>
                        </em>
                    </h3>
                    <!-- <div class="ts">
                        <span class="fl-lef">温馨提示：</span>
                        <span class="fl-lef">上传优质简历，坐等收钱。</span>
                    </div> -->
                    <div class="clearfix ero ts" style="display:block">
                        ...
                        <span class="fl-lef dis-block dis-inlin clearfix">
                            ...
                            <span class="fl-lef dis-block dis-inlin" style="width:597px;" id='fitjobCount'>
                                <?php if(!empty($_SESSION['fitjobCount'])){ echo "简历上传成功，现有<b style='color:#f99e07'>".$_SESSION['fitjobCount']."</b>个职位跟该候选人匹配，<a href='/Home/Index/search/position/".$_SESSION[fitjobKeyword].".html'>马上去看看</a>"; $_SESSION['fitjobCount']=null; $_SESSION['fitjobKeyword']=null; }else{ echo "上传优质简历，坐等收钱。"; } ?>
                            </span>
                        </span>
                    </div>
                    <div class="clearfix ero ts undis userinfo-notice">
                        <b class="fl-lef dis-block dis-inlin" style="margin-left:0px;">温馨提示:</b>
                        <span class="fl-lef dis-block dis-inlin clearfix">
                            <i class="fl-lef dis-block dis-inlin"></i>
                            <span class="fl-lef dis-block dis-inlin" style="width:597px;">验证手机号码后才可以推荐！<a class="fl-rig" href="/Home/Login/userinfo.html">立即去验证</a></span>
                        </span>
                    </div>
                    <div class="ts undis userinfo-notice">
                        <span class="fl-lef">温馨提示：</span>
                        <span class="fl-lef">验证手机号码后才可以推荐！</span>
                        <a class="fl-rig" href="/Home/Login/userinfo.html">立即去验证</a>
                    </div>
                    <div class="mytable" <?php if(empty($list['arResumeList'])):?>style='padding-bottom: 0px;border-bottom:none;'<?php endif;?>>

                         <div class="tb-list">
                            <ul class="clearfix th-head">
                                <li class="fl-lef wh54">序号</li>
                                <li class="fl-lef wh86">姓名</li>
                                <li class="fl-lef wh73">沟通结果</li>
                                <li class="fl-lef wh33">性别</li>
                                <li class="fl-lef wh128">求职意向</li>
                                <li class="fl-lef wh97">手机</li>
                                <li class="fl-lef wh80">上传时间</li>
                                <li class="fl-lef wh125">操作</li>
                            </ul>
                            <?php if(!empty($list['arResumeList'])):?>
                            <?php foreach($list['arResumeList'] as $arResumeList):?>

                            <div class="bt-odiv clearfix">
                                <div class="dis-block fl-lef wh54"><?php echo $arResumeList['sort_id'];?></div>
                                <div class="dis-block fl-lef wh86"><?php echo $arResumeList['username'];?></div>
                                
                                <div class="dis-block fl-lef wh73 <?php if($arResumeList['teleresult']):?>zt<?php endif;?>">
                               
                                        <?php if($arResumeList['teleresult']):?>
                                             <span class="zt-text">
                                        <i><?php echo $arResumeList['teleresult'];?></i>
                                        <b></b>
                                         </span>
                                        <?php else:?>
                                         <i>暂无沟通</i>
                                ...
                                <div class="dis-block fl-lef wh33"><?php echo $arResumeList['sex'];?></div>
                                <div class="dis-block fl-lef wh128"><?php echo $arResumeList['keyword'];?></div>
                                <div class="dis-block fl-lef wh97"><?php echo $arResumeList['mobile'];?></div>
                                <div class="dis-block fl-lef wh80"><?php echo $arResumeList['posttime'];?></div>
                                <div class="dis-block fl-lef wh125 last-sp">
                                    <a href="/Home/Login/Recommended/act/setResume/id/<?php echo $arResumeList['id'];?>.html" class="edit">编辑</a>
                                    <a href="" class="delete removeResume" id='<?php echo $arResumeList["id"];?>'>删除</a>
                                </div>
                            </div>
                            ...
                            <?php else:?>
                            <div class="bt-odiv clearfix">
                                <center style="margin-top: 10px">	暂无记录</center>
                            </div>
                            <?php endif?>	
                            <?php echo $list['page']?>
                        </div>
                ...
                <div class="add-resume<?php if($act == ''):?> undis<?php endif;?>" style="padding-top:10px;">
                    <div class="clearfix ero ts" style="display: block;margin-left: 24px;margin-bottom: 20px;margin-top: 0;">
                        <b class="fl-lef dis-block dis-inlin" style="margin-left:0px;">温馨提示:</b>
                        <span class="fl-lef dis-block dis-inlin clearfix">
                            <i class="fl-lef dis-block dis-inlin"></i>
                            <span class="fl-lef dis-block dis-inlin" style="width:563px;" id="fitjobCount">
                                上传优质简历，坐等收钱。                            </span>
                        </span>
                    </div>
                    <ul class="nav3 clearfix">
                        <li class="dis-block dis-inlin fl-lef hover-hand<?php if($type == 1):?> m<?php endif;?>">上传简历模式</li>
                        <li class="dis-block dis-inlin fl-lef hover-hand<?php if($type == 2):?> m<?php endif;?>">在线简历模式</li>
                    </ul>

                    <div class="public upload-resume" style="position:relative;<?php if($type == 2):?>display: none<?php endif;?>">
                        ...
                        <form action="/Home/Login/btjadd" method="post" enctype="multipart/form-data"  class="resubmitForm1" onsubmit="return;">
                            ...
                            <ul>
                                ...
                                <?php if($upload_resume != 1 && $upload_resume_set!=1 || $upload_resume_rec==1):?> <!--如果是上传简历活动模式，就只留下姓名、电话、上传简历等模块-->
                                <li class="clearfix">
                                ...
                                <?php if($upload_resume != 1 && $upload_resume_set!=1):?> <!--如果是上传简历模式，就只留下姓名、电话、上传简历等模块-->
                                <li class="clearfix">
                                ...
                                <li class="clearfix" style="position:relative">
                                    ...
                                    <span style="position:relative" class="dis-block dis-inlin fl-lef record-set-span xuanze_span  cheack" onclick="$('.tuanchu1').show();">
                                        ...
                                        <input type="text" style="width:310px;" id="match_industry_val1" readonly="true"  placeholder="择期望候选人上份工作的行业"   value="<?php echo ($resumeInfo['xfhy']); ?>" class="dis-inlin dis-block fl-lef record-set-input dq_xuanze text">
                                        <b class="dq_xuanze"></b>
                                    </span>
                                    <div style="position:absolute;left:75px;top:38px;" id="tuan2" class="tuanchu1 pa libao undis" >
                                        <div class="anniu tar">
                                ...
                                <?php if($upload_resume != 1 && $upload_resume_set!=1):?> 
                                <li class="clearfix">
                            ...
                            <div class="resume-annex">
                                ...
                                <dl  class="clearfix"  style="padding:12px 0px 20px 72px;width:435px;<?php if(!$resumeInfo[upload] || $resumeInfo[upload] =='/Uploads/word/'){ echo "display:none";}?>"  id="upd12">
                                     <dt class="fl-lef" style="margin-top:5px;margin-left:0;width:42px;"><img src="/Public/img/cwjl.png"></dt>                                                                                                      <dd style="font-size: 16px;width: 183px;margin-top: -5px; text-align: center; line-height: 35px;" class="jianliurl fl-lef"> <a class="wk dis-block" style="width:100%;height:100%;" href='<?php echo $resumeInfo[upload];?>'><?php echo $resumeInfo[updateName];?></a></dd>                                                                                                                                       <span style="color: #2380b8;position: absolute;bottom: 57px;right: 20px;cursor:pointer" onclick="$('#upd11').show();
                                             $('#upd12').hide();
                                             $('.jianliurl').html('重新上传简历')">删除</span>                                                                                                                                                </dl>                                                                                                                                                <input type='hidden' value='1' id='updateNUm'>                                                                                                                                                <input type='hidden' id='updateFile' name='updateFile' value='<?php echo ($resumeInfo[updateFile]); ?>'>                                                                                                                                                <input type='hidden'  id='updatePath' name='updatePath' value='<?php echo ($resumeInfo[updatePath]); ?>'>
                                                                                                                                                                       <script type="text/javascript">
                                    ...
                                    <span class="dis-block dis-inlin clearfix">
                                        <i class="fl-lef dis-block dis-inlin"></i>
                                        <span  style="width:526px;" class="fl-lef dis-block dis-inlin">指候选人在某方面有突出的技能、价值点。</span>
                                    </span>
                                </div>
                                <div class="recmd-reason" id="bjq">
                                    ...
                                    <!-- <div class="bjq-con">
                                      <input type="text" class="lyou" placeholder="请输入推荐理由" >
                                        <div class="recmd-reason undis" id="bjq">
                                            <script id="editor" name="because" type="text/plain" style="width:606px;height:300px;margin-top:10px;margin-left: 70px"><?php echo ($resumeInfo[because]); ?></script>
                                        </div>  
                                    </div> -->
                                    ...
                                    <ul>
                                        <li>
                                            <input type="checkbox" id="ck1" style="margin-top:10px;margin-right: 10px;" name="isRecord" checked <?php if($matchResume):?>checked  onclick="return false"<?php endif;?>/><label for="ck" style='font-size: 18px;font-weight: bold;'>委托系统管理</label><br>

                                        <div class="clearfix ero" style="display:block;margin-bottom:10px">
                                                <b class="fl-lef dis-block dis-inlin" style="margin:0px;">温馨提示:</b>
                                            <span class="fl-lef dis-block dis-inlin clearfix" style="height:auto">
                                                    <i class="fl-lef dis-block dis-inlin"></i>
                                                    <span class="fl-lef dis-block dis-inlin" style="width:531px;height:auto!important;line-height:20px;">勾选委托系统管理上传简历后，坐等候选人入职，赚取收益（上传简历，有新职位发布时、人人猎系统会自动匹配你简历库中相关候选人，沟通满足企业要求的候选人对该职位的意愿，协调候选人入职后，你就马上得到推荐奖金-整个流程中 <b>只需上传简历</b>)</span>
                                            </span>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <p style="margin-left:103px;margin-top:80px;" class="error undis" id="resume_error1">错误</p>
                                <center id="jlbtn1" > 
                                    <span class="btn btn2 hover-hand" onclick="savaResumeType(1);" style="margin-top: 95px;width: 127px;margin-left: -10px"><?php echo $isNewUser;?></span>
                                    </center>
                                    <center style="display:none" id="jlbtn2" > 
                                        <span class="btn btn2 hover-hand" style="margin-top: 95px;width: 127px;margin-left: -10px;"><?php echo $isNewUser;?></span>
                                </center>
                                <input type='hidden' value='<?php echo $Recordtype;?>' name='Recordtype'>
                            </form>
                        </div>

                        <div class="public" style="position:relative;<?php if($type == 1):?>display: none<?php endif;?>">
                            <form action="/Home/Login/btjadd" method="post" enctype="multipart/form-data" class="resubmitForm2">
                                ...
                                <ul>
                                    ...
                                    <?php if($upload_resume != 1 && $upload_resume_set!=1 || $upload_resume_rec==1):?> 
                                    <li class="clearfix">
                                        <em class="dis-block dis-inlin fl-lef">年&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp龄</em>
                                    ...
                                    <li class="clearfix" style="position:relative">
                                            ...
                                            <span style="position:relative" class="dis-block dis-inlin fl-lef record-set-span xuanze_span  cheack" onclick="$('.tuanchu2').show();">
                                                ...
                                                <input type="text" style="width:310px;" id="match_industry_val2" readonly="true"  value="<?php echo ($resumeInfo['xfhy']); ?>" class="dis-inlin dis-block fl-lef record-set-input dq_xuanze text">
                                            <b class="dq_xuanze"></b>

                                        </span>
                                        <div style="position:absolute;left:75px;top:38px;" id="tuan"  class="tuanchu2 pa libao undis" >
                                            <div class="anniu tar">
                                                <span class="fwb fs14 fl fcf">细分行业：</span>
                                                <a class="qued" href="javascript:void(0);">[确定]</a>
                                                <a class="qux" href="javascript:void(0);">[取消]</a>
                                ...
                                <div style="display: block;margin-left: 24px;margin-bottom: 20px;margin-top: 10px;" class="clearfix ero ts">
                                    ...
                                    <span class="dis-block dis-inlin clearfix">
                                        <i class="fl-lef dis-block dis-inlin"></i>
                                        <span  style="width:497px;" class="fl-lef dis-block dis-inlin">指候选人大学以后的教育以及培训记录。</span>
                                    </span>
                                </div>
                                <div class="odiv">
                                ...
                                <div style="display: block;margin-left: 24px;margin-bottom: 20px;margin-top: 10px;" class="clearfix ero ts">
                                    ...
                                    <span class="dis-block dis-inlin clearfix">
                                        <i class="fl-lef dis-block dis-inlin"></i>
                                        <span  style="width:497px;" class="fl-lef dis-block dis-inlin">指候选人的过往工作经历，含项目经验。</span>
                                    </span>
                                </div>
                                <div class="odiv">
                                    <div class="con clearfix">
                                ...
                                <div style="display: block;margin-left: 24px;margin-bottom: 20px;margin-top: 10px;" class="clearfix ero ts">
                                    ...
                                    <span class="dis-block dis-inlin clearfix">
                                        <i class="fl-lef dis-block dis-inlin"></i>
                                        <span  style="width:497px;" class="fl-lef dis-block dis-inlin">指候选人获取的各种技能的专业证书</span>
                                    </span>
                                </div>
                                ...
                                <script>var ue4 = UE.getEditor('editor4');</script>
                                <?php endif;?>
                                <div style="width:100%;height:10px;margin-top:20px; background:#f5f5f5;"></div>
                                <div style="display: block;margin-left: 24px;margin-bottom: 20px;margin-top: 10px;" class="clearfix ero ts">
                                    <span class="fl-lef" style="font-size:18px;font-weight:bold;"><img src='/Public/img/rcmd-img/icon2.png' style='margin-right:10px;'>推荐理由</span>
                                    <span class="dis-block dis-inlin clearfix">
                                        <i class="fl-lef dis-block dis-inlin"></i>
                                        <span  style="width:497px;" class="fl-lef dis-block dis-inlin">指候选人在某方面有突出的技能、价值点。</span>
                                    </span>
                                </div>
                                <div class="odiv">
                                ...
                                <ul>
                                    ...
                                    <li >
                                        <input type="checkbox" id="ck2" style="margin-top:10px;margin-right: 10px;" name="isRecord"  checked  <?php if($matchResume):?>checked  onclick="return false"<?php endif;?>/><label for="ck" style='font-size: 18px;font-weight: bold;'>委托系统管理</label><br>
                                        <div class="clearfix ero" style="display:block;margin-bottom:10px">
                                                <b class="fl-lef dis-block dis-inlin" style="margin:0px;">温馨提示:</b>
                                            <span class="fl-lef dis-block dis-inlin clearfix" style="height:auto">
                                                    <i class="fl-lef dis-block dis-inlin"></i>
                                                    <span class="fl-lef dis-block dis-inlin" style="width:520px;height:auto!important;line-height:20px;">勾选此项上传简历后，坐等候选人入职，赚取收益（上传简历，有新职位发布时、人人猎系统会自动匹配你简历库中相关候选人，沟通满足企业要求的候选人对该职位的意愿，协调候选人入职后，你就马上得到推荐奖金-整个流程中<b>只需上传简历</b>)</span>
                                            </span>
                                        </div>
                                    </li>
                                    <input type='hidden' name='mssj'>
                                    ...
                                    <p style="margin-left:103px;margin-top:80px;" class="error undis" id="resume_error2">错误</p>
                                    <center id="jlbtn3"> <span  class="btn btn2 hover-hand" onclick="savaResumeType(2);" style="margin-top: 95px;width: 127px;margin-left: -10px"><?php echo $isNewUser;?></span></center>
                                        <center id="jlbtn4" style="display:none"> <span  class="btn btn2 hover-hand" style="margin-top: 95px;width: 127px;margin-left: -10px"><?php echo $isNewUser;?></span></center>
                                    </ul>
            ...
            <input type='hidden' value='<?php echo $Recordtype;?>' id='Recordtype'>
            <div class="al-footer">
    <div class="wrap">
        ...
        <dd><input type="hidden" id="locationHref"><button id="comWind" class="cur_point">确认</button></dd>
            ...
            <script>
                ...
                $(function() {
                    changeHy(20, 'area2');
                    changeHy(20, 'area1');
                    $(".addResumeAct").click(function() {
                        $.post("/Home/Login/isComplatdUser.html", {}, function(data) {
                            if (data.code == "200") {
                                location.href = "/Home/Login/Recommended/act/addResume.html"
                            } else {
                                $(".ts span span").html("验证手机号码后才可以推荐！" + '<a class="fl-rig" href="/Home/Login/userinfo.html">' + '立即去验证' + '</a>');
                            }
                        }, "json")
                    });
                })
                ...
                function savaResumeType(type) {
                    ...
                    if (!age && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1" || "<?php echo $upload_resume_rec?>" == "1")) {
                    ...
                    if (!email && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1" || "<?php echo $upload_resume_rec?>" == "1")) {
...
//                     }*/
                    ...
                    if (!mobile || mobile.length != 11) {
                        $(".error-mobile" + type).html('请正确填写联系电话');
                        $(".error-mobile" + type).show();
                        $("#mobile" + type).focus();
                        $("#resume_error" + type).html('请正确填写联系电话');
                        $("#resume_error" + type).show();
                        btn2.hide();
                        btn1.show();
                        return false;
                    ...
                    if (!state && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    if (match_company == "请选择" && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    if (match_educational == "请选择" && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    if (match_treatment == "请选择" && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    if ((!match_industry || match_industry == '请选择') && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    if ((!match_title || match_title == '请选择') && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    if ((!match_skill || match_skill == '请选择') && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    if (!match_area && ("<?php echo $upload_resume?>" != "1" && "<?php echo $upload_resume_set?>" != "1")) {
                    ...
                    $.post("/Home/Login/isNewUser.html", {'Recordtype': Recordtype}, function(data) {
                        if (data == 2) {
                ...
                $(function() {
                    ...
                    var divs2 = $(".add-resume>.public");
                    list2.on("click", function() {
                        that = $(this);
                        index = that.index();
                        that.addClass("m").siblings().removeClass("m");
                        $(this).find("a").addClass("m").parent("li").siblings().find("a").removeClass("m");
                        divs2.eq(index).show().siblings(".public").hide();
                    });
                ...
                /*
                 ...
                 if(tdSize>0){
                 var html  = "<tr colspan="+tdSize+" style='border:0px'><td  style='border:0px'></td></tr>"
                 $(this).after(html);
                 }
                ...
                $(function() {
                    ...
                    /*  $(".lyou").focus(function(){
                     $(this).hide();
                     $("#bjq").slideDown();    
                     $(".bjq-con").css({"height":"345px"})                     
                     })
                     function editor(){
                     $("#bjq").slideUp();    
                     $(".bjq-con").css({"height":"50px"});
                     $(this).show();   
                     }
                     ...
                     var erval = ue1.getContentTxt="";
                     $(".lyou").val(erval);
                     });*/
                })
                $(function() {
                    var ztTextHeight = $(".zt-text").height();
                    $(".zt-text").css("top", -ztTextHeight);
                    $(".bt-odiv .zt").on("mouseenter", function() {
                        $(this).find(".zt-text").show().parents(".bt-odiv").siblings().find(".zt-text").hide();
                    }).on("mouseleave", function() {
                        $(this).find(".zt-text").hide()
