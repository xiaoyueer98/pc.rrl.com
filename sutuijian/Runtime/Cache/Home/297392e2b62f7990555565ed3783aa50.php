		...
		<ul class="pd">
			...
			<li class="pd_list mytj">
				...
				<ul style="display:block">
					...
					<li><a href="<?php echo U('Login/SucceRecom');?>"><em class="hre">成功推荐 </em></a></li>
...
//-->
		...
		<div class="PersData">
			<div class="recom1 data recom2 recom4">
				<div class="recom1_tp">
					<h3>成功推荐</h3>
					<div class="tab">
						<table  border="1">
							...
							<tr class="bg">
								<td height="40px">1</td>
								<td height="40px">杨帆</td>
								<td height="40px">北京热贝惠卖科技有限公司</tb>
								<td><a href="<?php echo U('Login/EnterIndex2');?>">Andriod研发工程师</a></td>
								<td height="40px">1600</td>
								<td height="40px">未打款</td>
							</tr>
							<tr>
								<td>1</td>
								<td>杨帆</td>
