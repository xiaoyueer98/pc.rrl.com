...
<div class="popup_ft reward" id="sys_window">
    ...
    <div id="findpwd_kuang" class="wjmima">
        ...
        <h3></h3>
        <div class="jindutiao">
            <img src="/Public/img/wjmima_3.png" alt="">
        </div>

        <ul class="InputUl" style="margin-top:20px">
            <?php if($find_pwd_third):?>
            <li style="padding-top:20px;">用户名：<label><?php echo $find_pwdusername ?></label></li>
            <?php else:?>
            <li style="padding-top:20px;margin-left:-70px;"><?php echo $find_pwdusername ?></li>
            <?php endif;?>
            <li><input type="password" id="findpwdpassword" name="password" placeholder="请输入新密码" onkeydown="KeyDown();"></li>
            <li><input type="password" id="findpwdrepassword" placeholder="再次输入新密码" onkeydown="KeyDown();"></li>

            <p class="error2" style="display: none">两次密码输入不相符</p>
        </ul>
        <input class="mimaqueren1" type="button" value="确认" id="zhaomima">
        <input type='hidden' value='/Home/Index/index' id='locationHref'>
    </div>
    ...
    <script type="text/javascript">
        ...
        $("#findpwdpassword,#findpwdrepassword").focus(function(){
