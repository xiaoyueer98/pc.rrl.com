...
<div class="popup_ft reward" id="sys_window">
    ...
    <div id="findpwd_step1" class="wjmima">
        ...
        <h3></h3>
        <div class="jindutiao">
            <img src="/Public/img/wjmima_1.png" alt="">
        </div>
        <ul class="InputUl" style="height:70px;">
            <li>
                <input type="text"  name="usernameEmail" default="请输入您的手机或邮箱" value="请输入您的手机或邮箱" id='usernameEmail'  onkeydown="KeyDown(event);"/>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("input[name='usernameEmail']").focus(function() {
                $("input[name='usernameEmail']").css("color","#343434");
            ...
            $("#usernameEmail").blur(function() {
                ...
                if (!$(this).val()) {
                    $("#usernameEmail").css("color","#b7b6b6");
        ...
        $("#zhaohuimima").click(function() {
            ...
            $.post("/Home/Index/huoquyou", {
                'email': email,
                'type': type
            }, function(data) {
                if (data.code == 200) {
                    location.href = "/Home/Index/huoquyou2.html";
                    return false;
                } else {
                    $("#zhaohuimima").attr("disabled", false);
