                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="wh152 wk table-text-left position-name" style="position:relative">
                                        ...
                                        <img src="/images/ntice3.png" class="img-btn hover-hand"  onclick="commentDiv('<?php echo $arRecordInfo[id];?>')">
                                        <?php endif;?>
                                    </td>
                                    ...
                                    <td class="wh124 wk shenhed hover-hand" style="position:relative" tid="<?php echo $arRecordInfo['id'];?>" onclick="showDisMsg('<?php echo $arRecordInfo[disreason];?>')">
                                        ...
                                        <img src="/images/ntice2.png" class="img-btn hover-hand" style='bottom: 2px;position: absolute;right: 2px;' onclick="commentDiv('<?php echo $arRecordInfo[id];?>')"/>
                                    </td>
                                    <?php else:?>
