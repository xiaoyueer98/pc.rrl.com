    ...
    <div class="wrap">
        ...
        <div class="ms2 clearfix">
            ...
            <div class="ms2-r dis-inlin dis-block fl-rig">
                ...
                <a  href='/Home/Active/salon_show.html' target='_blank'><img src="/Public/img/new-index/shalong-hd.png" alt=""></a>
    ...
    <div id="J_CatBd" class="cat-bd">
        <div id="J_CatMenu" class="cat-menu">
            ...
            <div class="ms3-r fl-rig">
                ...
                <div class="con-public con-remen" style="display:block;margin-top: 1px;">
                ...
                <div class="con-public con-zuixin" style="display:none;margin-top:1px;">
...
<div class="popup_ft reward" id="sys_window">
    ...
    <div class="wjmima">
        ...
        <div class="jindutiao2">
            <img src="/Public/img/wjmima2.png" alt="">
        </div>
        <div class="pswdEmail">
    ...
    <div id="" class="wjmima">
        ...
        <h3></h3>
        <div class="jindutiao2">
            <img src="/Public/img/wjmima_2.png" alt="">
        </div>
        <div class="pswdEmail">
            <p style="font-size:14px;">您的手机号是：<span><?php echo $email;?></span></p>
            <p class="p2 clearfix"><em class="vft_text">验证码：</em><input type="text" class="phone" id="findpwd_code" onkeydown="KeyDown(event);"><button class="btn_vft cur_point" id="findpwd_getcode">获取验证码</button><label class="vfit_btn2 undis"  style="margin-left:10px" id="findpwd_codetimes"><i>60</i>秒后重新获取</label></p>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#findpwd_step2").click(function() {
                ...
                $.post("/Home/Index/checkfindpwdcode", {"findpwd_code": findpwd_code}, function(data) {
                    if (data.code != "500") {
                        location.href = "/Home/Index/changePwssword.html"
                    } else {
            ...
            $("#findpwd_getcode").click(function() {
                ...
                $.post("/Home/Index/findpwdcode.html", {hash:hash}, function(data) {
                    if (data.code != "500") {
