		...
		<ul class="pd">
			...
			<li class="pd_list">
				...
				<ul style="display:block">
					<li><a href="<?php echo U('Login/ReceivAccount');?>"><em class="hre">收款账号</em></a></li>
				...
				<div class="ra_top">
					...
					<div class="ra-cn">
						<div class="content" id="content1" style="display:none;">
							...
							<form action="" method="">
							<dl>
								<dt><img src="/Public/img/ra_icon.png" alt=""></dt>
								<dd>
									<p><em>收款银行：</em><input type="text" id="bankname" value=""></p>
									<p><em>收款账号：</em><input type="text" value="" id="banknumber"></p>
								</dd>
							</dl>
							<input type="button" class="btn_xg" id="btn_xg2" value="保存" onclick="addbackinfo()">
							</form>
						</div>
						<div class="content" id="content2">
							...
							<dl>
								...
								<dd>
									...
									<p><em>收款银行：</em><span id="rbankname"><?php echo ($info['bankname']); ?></span></p>
									<p><em>收款账号：</em><span id="rbanknumber"><?php echo ($info['banknumber']); ?></span></p>
									
								</dd>
								
							</dl>
							<input type="button" class="btn_xg" id="btn_xg1" value="修改">
						</div>
					</div>
				</div>
...
function addbackinfo()
{
	...
	$.ajax({
		...
		url:"/index.php?s=/Home/Login/addbackinfo",
		type:"post",
