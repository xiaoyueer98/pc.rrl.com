...
<div class="cfid">
 ...
 <script type="text/javascript" src="/Public/js/denglu.js"></script>
    ...
    <div class="wrap">
        <div class="links">
            <div class="title">
                <span class="dis-block fl-lef">Links</span>
                <em class="dis-block fl-lef">友情链接</em>
            </div>
            <ul class="clearfix">
                <?php foreach($linkArr as $v):?>
                <li class="fl-lef"><a href="<?php echo $v['linkurl']?>" target='_blank'><?php echo $v['webname']?></a></li>
                <?php endforeach;?>


            </ul>
            <div class="btn-con clearfix">
                <span class="btn m"><a href='/'  style='color:#fff;'>访问首页</a></span>
                <span class="btn"><a href='/Home/Index/search.html'  style='color:#979797;'>高级搜索</a></span>
            </div>
        </div>
    </div>
    <div class="al-footer">
