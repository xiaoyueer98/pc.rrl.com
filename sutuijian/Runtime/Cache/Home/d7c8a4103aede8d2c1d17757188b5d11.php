...
//-->
		...
		<div class="Ent_con">
			<ul>
			<?php if(is_array($comp)): $i = 0; $__LIST__ = $comp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cp): $mod = ($i % 2 );++$i;?><li class="Ent_list">
					<dl class="clearfix frist">
						<dt class="myfile">
							<input type="file">
						</dt>
						<dd>
							<h4><?php echo ($cp["cpname"]); ?></h4>
							<p><em>地址：</em><span><?php echo ($cp["address"]); ?></span></p>
							<p><em>主页：</em><span><a href=""><?php echo ($cp["webname"]); ?></a></span></p>
						</dd>
					</dl>
				</li>
				<li class="Ent_list">
				...
				<li>
					...
					<ul class="m">
						<li class="ls">
							<dl class="clearfix">
							<?php if(is_array($comp)): $i = 0; $__LIST__ = $comp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$more): $mod = ($i % 2 );++$i; endforeach; endif; else: echo "" ;endif; ?>
								<dt class="clearfix"><a href="/index.php?s=/Home/Login/EnterIndex2&comid=<?php echo $_GET['comid']; ?>&jobid=<?php echo $_GET['jobid']; ?>"><?php echo ($more["cascname"]); ?></a><span>￥<?php echo ($more["Tariff"]); ?></span></dt>
								<dd>
									<a href=""><?php echo ($more["ccasc"]); ?></a>
									<a href=""><?php echo ($more["ccas"]); ?></a>
									<a href=""><?php echo ($more["casc"]); ?></a>
									<em>￥<?php echo ($more["dataname"]); ?></em>
								</dd>
							</dl>
						</li>
					</ul>
			...
			<ul class="fixed">
				<?php if(is_array($cinfo)): $i = 0; $__LIST__ = $cinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><em>融资阶段：</em><span><?php echo ($vo["jieduan"]); ?></span></li>
				<li><em>性质：</em><span><?php echo ($vo["xingzhi"]); ?></span></li>
				<li><em>规模：</em><span><?php echo ($vo["guimo"]); ?></span></li>
				<li><em>成立日期：</em><span>2012.09</span></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
